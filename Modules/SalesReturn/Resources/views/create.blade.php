                ...
                <div class="card-body">
                    ...
                    <form id="sale-return-form" action="{{ route('sale-returns.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="paid_amount">Nominal Dikembalikan <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="note">Catatan (Bila Perlu)</label>
                            <textarea name="note" id="note" rows="5" class="form-control"></textarea>
                        </div>

                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">
                                Simpan Retur Penjualan <i class="bi bi-check"></i>
                            </button>
                        </div>
                    </form>
                </div>
