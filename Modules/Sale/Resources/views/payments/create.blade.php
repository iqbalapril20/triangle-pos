                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">
                            Simpan Pembayaran <i class="bi bi-check"></i>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="reference">No. Invoice <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="due_amount">Sisa Tagihan <span class="text-danger">*</span></label>
