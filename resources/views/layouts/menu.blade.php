...
<li
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('purchase-returns.*') ? 'c-active' : '' }}"
                href="{{ route('purchase-returns.index') }}">
                <i class="c-sidebar-nav-icon bi bi-arrow-return-right"></i> Retur Pembelian
            </a>
        </li>
        @endcan
    </ul>
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('sale-returns.*') ? 'c-active' : '' }}"
                ...
                <i class="c-sidebar-nav-icon bi bi-arrow-return-left"></i> Retur Penjualan
            </a>
        </li>
        @endcan
    </ul>
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('purchases-return-report.index') ? 'c-active' : '' }}"
                ...
                <i class="c-sidebar-nav-icon bi bi-file-earmark-text"></i> Laporan Retur Pembelian
            </a>
        </li>
    </ul>
</li>
