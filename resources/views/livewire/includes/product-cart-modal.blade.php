        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if (session()->has('discount_warning' . $cart_item->id))
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <div class="alert-body">
                                <span>{{ session('discount_warning' . $cart_item->id) }}</span>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Tutup">
                                    <span aria-hidden="true">×</span>
                                </button>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        @elseif($discount_type[$cart_item->id] == 'fixed')
                            <label>Diskon (Nominal) <span class="text-danger">*</span></label>
                            <input wire:model="item_discount.{{ $cart_item->id }}" type="number" class="form-control"
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click="setProductDiscount('{{ $cart_item->rowId }}', {{ $cart_item->id }})"
                        type="button" class="btn btn-primary">Simpan Diskon</button>
                </div>
            </div>
        </div>
    </div>
