...
class PurchasesReport extends Component
{
    ...
    public function render()
    {
        ...
        // Hitung Grand Total sebelum Paginate (Harus dibagi 100 karena Accessor model tidak bekerja dengan sum())
        ...
        $purchases = (clone $query)->orderBy('date', 'desc')->paginate(10);
